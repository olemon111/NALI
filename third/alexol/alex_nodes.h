...
public:
  ...
  */
  ...
  inline bool get_write_lock() {
    ...
    while (!alexol_CAS(&lock_, &old_value, new_value)) {
  ...
  inline bool try_get_write_lock() {
    ...
    if (!alexol_CAS(&lock_, &old_value, new_value)) {
      return false;
    }
  ...
  inline bool try_get_read_lock() {
    ...
    return alexol_CAS(&lock_, &old_value, new_value);
  }
...
public:
  ...
  inline void get_link_lock() {
    ...
    do {
      ...
      new_value = old_value | lockSet;
    } while (!alexol_CAS(&link_lock_, &old_value, new_value));
  }
  ...
  inline bool try_get_link_lock() {
    ...
    old_value &= lockMask;
    new_value = old_value | lockSet;
    return alexol_CAS(&link_lock_, &old_value, new_value);
  }
